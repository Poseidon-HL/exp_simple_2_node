...
void Packet::copy(const Packet& other)
{
    ...
    this->idx = other.idx;
    this->isParity_ = other.isParity_;
...
void Packet::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->isParity_);
...
void Packet::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->isParity_);
    doParsimUnpacking(b,this->sendTime);
}

int Packet::getStreamId() const
{
    return this->streamId;
}

void Packet::setStreamId(int streamId)
{
    this->streamId = streamId;
}

int Packet::getIdx() const
{
    return this->idx;
}

void Packet::setIdx(int idx)
{
    this->idx = idx;
}

bool Packet::isParity() const
{
    return this->isParity_;
}

void Packet::setIsParity(bool isParity)
{
    this->isParity_ = isParity;
}

double Packet::getSendTime() const
{
    return this->sendTime;
}

void Packet::setSendTime(double sendTime)
{
...
unsigned int PacketDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_idx
        FD_ISEDITABLE,    // FIELD_isParity
...
int PacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "idx") == 0) return baseIndex + 1;
    if (strcmp(fieldName, "isParity") == 0) return baseIndex + 2;
...
std::string PacketDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_idx: return long2string(pp->getIdx());
        case FIELD_isParity: return bool2string(pp->isParity());
...
void PacketDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_idx: pp->setIdx(string2long(value)); break;
        case FIELD_isParity: pp->setIsParity(string2bool(value)); break;
...
omnetpp::cValue PacketDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_idx: return pp->getIdx();
        case FIELD_isParity: return pp->isParity();
...
void PacketDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    switch (field) {
        ...
        case FIELD_idx: pp->setIdx(omnetpp::checked_int_cast<int>(value.intValue())); break;
        case FIELD_isParity: pp->setIsParity(value.boolValue()); break;
